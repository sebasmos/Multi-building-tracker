'''
Pre_trained script with data_augmentation based on Albumentations 
...
THRESHOLD = 0.6
PREDICT = False
filename = "best.pth" # my_checkpoint.pth.tar
...
ENCODER = 'vgg16'#'resnet101'#'se_resnext50_32x4d'
...
testing_set = Dataloader_trdp_pre_trained(root_dir=test_dir,
                              ...
                              chip_dimension=chip_dimension,
                              preprocessing=get_preprocessing(preprocessing_fn),transform=transform_testing)
