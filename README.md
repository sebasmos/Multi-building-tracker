...
This project is licensed under the MIT License and the copyright belongs to Sebastián Cajas & Julián Salazar- See [docs](https://drive.google.com/file/d/1Rbc202UVYKSnIZx3vauio32_Ty-SJmIy/view?usp=sharing) for the quoted works and detailed references - see the [LICENSE](https://github.com/sebasmos/Building.predictor/blob/main/LICENSE) file for details.
